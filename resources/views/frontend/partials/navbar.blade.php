...
<head>
    <meta charset="utf-8">
    <title>Sobat Sehat - Pelayanan Masyarakat</title>
        ...
        <div class="row gx-0 d-none d-lg-flex">
            ...
            <div class="col-lg-5 px-5 text-end">
                <div class="h-100 d-inline-flex align-items-center py-3 me-4">
                    ...
                    <small>+62857 8824 1715</small>
                </div>
                <div class="h-100 d-inline-flex align-items-center">
                    <a class="btn btn-sm-square rounded-circle bg-white text-primary me-0" href=""><i
                            class="fab fa-instagram"></i></a>
                    <small><a href="https://instagram.com/@Alpukat6_rpl">@Alpukat6_rpl</a></small>
                </div>
            </div>
        </div>
    </div>
