        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Form Tambah Jadwal Kegiatan</h4>
                </div>
                <div class="card-body">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="nama_acara"
                                                placeholder="Masukkan Nama Jadwal Kegiatan Terbaru.." name="nama_acara"
                                                required>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-5">
                                            <input type="date" class="form-control" id="tanggal"
                                                placeholder="Masukkan Waktu Jadwal Kegiatan Terbaru.." name="tanggal"
                                                required>
                                            <div class="invalid-feedback">
